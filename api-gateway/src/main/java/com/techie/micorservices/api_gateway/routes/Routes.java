package com.techie.micorservices.api_gateway.routes;
...
public class Routes {
    ...
    public RouterFunction<ServerResponse> fallbackRoute(){
        return route("fallbackRoute").GET("/fallbackRoute", request -> ServerResponse.status(HttpStatus.SERVICE_UNAVAILABLE).body("Service is not available")).build();
    }
}
